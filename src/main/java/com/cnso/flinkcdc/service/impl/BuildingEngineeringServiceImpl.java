 ...
 */
public class BuildingEngineeringServiceImpl extends BaseService {

    @Override
    public void initInsertTmpSql(StringBuffer sqlBuf) {
        sqlBuf.append("INSERT INTO `t_building_engineering_tmp` (`id`,`_id`,`type`,`license_name`,`register_no`,`valid_start`,`valid_end`,`state`,`state_code`,`ename_cn`,`ename_en`,`address`,`kind_level`,`qualification_level`,`valid`,`scope`,`u_tags`,`is_history`,`create_time`,`row_update_time`,`local_row_update_time`,`update_time`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,NOW())");
    }
    ...
    public void initPs(PreparedStatement ps, Map<String, Object> datum) throws Exception {PreparedStatementUtils.setLong(1, datum.get("id"),ps);
        ...
        ps.setString(10, PreparedStatementUtils.getStringVal("ename_cn", datum));
        ps.setString(11, PreparedStatementUtils.getStringVal("ename_en", datum));
        ps.setString(12, PreparedStatementUtils.getStringVal("address", datum));
        ps.setString(13, PreparedStatementUtils.getStringVal("kind_level", datum));
        ps.setString(14, PreparedStatementUtils.getStringVal("qualification_level", datum));
        ps.setString(15, PreparedStatementUtils.getStringVal("valid", datum));
