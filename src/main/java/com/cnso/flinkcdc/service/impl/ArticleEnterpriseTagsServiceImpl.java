 ...
 */
public class ArticleEnterpriseTagsServiceImpl extends BaseService {

    @Override
    public void initInsertTmpSql(StringBuffer sqlBuf) {
        sqlBuf.append("INSERT INTO `t_article_enterprise_tags_tmp` (`zz_id`,`id`,`eid`,`zz_eid`,`oid`,`new_tag`,`create_time`,`row_update_time`,`local_row_update_time`,`update_time`) VALUES (?,?,?,?,?,?,?,?,?,NOW())");
    }
    ...
    public void initPs(PreparedStatement ps, Map<String, Object> datum) throws Exception {
        ...
        ps.setString(6, PreparedStatementUtils.getStringVal("new_tag", datum));
        ps.setTimestamp(7, new Timestamp(TableUtils.getLong(datum.get("create_time").toString())));
