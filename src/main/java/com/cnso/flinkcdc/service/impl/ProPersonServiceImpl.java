 ...
 */
public class ProPersonServiceImpl extends BaseService {

    @Override
    public void initInsertTmpSql(StringBuffer sqlBuf) {
        sqlBuf.append("INSERT INTO `t_pro_person_tmp` (`id`,`_id`,`type`,`license_name`,`register_no`,`valid_start`,`valid_end`,`state`,`state_code`,`province`,`province_code`,`pname`,`work_type`,`license_organ`,`is_history`,`create_time`,`row_update_time`,`local_row_update_time`,`update_time`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,NOW())");
    }
    ...
    public void initPs(PreparedStatement ps, Map<String, Object> datum) throws Exception {
        ...
        ps.setString(12, PreparedStatementUtils.getStringVal("pname", datum));
        ps.setString(13, PreparedStatementUtils.getStringVal("work_type", datum));
        ps.setString(14, PreparedStatementUtils.getStringVal("license_organ", datum));
