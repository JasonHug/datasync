 ...
 */
public class BiddingContentOtherServiceImpl extends BaseService {

    @Override
    public void initInsertTmpSql(StringBuffer sqlBuf) {
        sqlBuf.append("INSERT INTO `t_bidding_content_other_tmp` (`id`,`content_text`,`content_html`,`content_swf`,`u_id`,`u_tags`,`qds`,`create_time`,`row_update_time`,`local_row_update_time`,`update_time`) VALUES (?,?,?,?,?,?,?,?,?,?,NOW())");
    }
