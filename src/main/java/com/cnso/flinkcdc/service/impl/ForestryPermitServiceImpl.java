 ...
 */
public class ForestryPermitServiceImpl extends BaseService {

    @Override
    public void initInsertTmpSql(StringBuffer sqlBuf) {
        sqlBuf.append("INSERT INTO `t_forestry_permit_tmp` (`id`,`_id`,`type`,`license_name`,`register_no`,`valid_start`,`valid_end`,`state`,`state_code`,`permit_project`,`area`,`number_organ`,`unit`,`app_number`,`app_date`,`app_state`,`is_history`,`create_time`,`row_update_time`,`local_row_update_time`,`update_time`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,NOW())");
    }
    ...
    public void initPs(PreparedStatement ps, Map<String, Object> datum) throws Exception {
        ...
        ps.setString(10, PreparedStatementUtils.getStringVal("permit_project", datum));
        ps.setString(11, PreparedStatementUtils.getStringVal("area", datum));
        ps.setString(12, PreparedStatementUtils.getStringVal("number_organ", datum));
        ps.setString(13, PreparedStatementUtils.getStringVal("unit", datum));
        ps.setString(14, PreparedStatementUtils.getStringVal("app_number", datum));
        ps.setString(15, PreparedStatementUtils.getStringVal("app_date", datum));
        ps.setString(16, PreparedStatementUtils.getStringVal("app_state", datum));
