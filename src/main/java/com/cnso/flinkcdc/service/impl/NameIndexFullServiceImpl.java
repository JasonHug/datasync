 ...
 */
public class NameIndexFullServiceImpl extends BaseService {

    @Override
    public void initInsertTmpSql(StringBuffer sqlBuf) {
        sqlBuf.append("INSERT INTO `t_name_index_full_tmp` (`zz_id`,`id`,`name`,`eid`,`zz_eid`,`province`,`credit_no`,`org_no`,`reg_no`,`status`,`oper_name`,`start_date`,`history_names`,`his_eids`,`data`,`number`,`update_time`,`row_update_time`,`local_row_update_time`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
    }
