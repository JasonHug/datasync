 ...
 */
public class TorchPlanServiceImpl extends BaseService {

    @Override
    public void initInsertTmpSql(StringBuffer sqlBuf) {
        sqlBuf.append("INSERT INTO `t_torch_plan_tmp` (`id`,`_id`,`eid`,`zz_eid`,`name`,`district`,`district_code`,`torch_plan_project`,`register_no`,`year`,`publish_date`,`remarks`,`level`,`url`,`u_tags`,`is_history`,`create_time`,`row_update_time`,`local_row_update_time`,`update_time`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,NOW())");
    }
    ...
    public void initPs(PreparedStatement ps, Map<String, Object> datum) throws Exception {
        ...
        ps.setString(8, PreparedStatementUtils.getStringVal("torch_plan_project", datum));
        ps.setString(9, PreparedStatementUtils.getStringVal("register_no", datum));
        ...
        ps.setString(12, PreparedStatementUtils.getStringVal("remarks", datum));
