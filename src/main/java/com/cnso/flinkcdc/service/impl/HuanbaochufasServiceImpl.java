 ...
 */
public class HuanbaochufasServiceImpl extends BaseService {

    @Override
    public void initInsertTmpSql(StringBuffer sqlBuf) {
        sqlBuf.append("INSERT INTO `t_huanbaochufas_tmp` (`_id`,`eid`,`zz_eid`,`province`,`name`,`punishments`,`created_time`,`punishment_date`,`row_update_time`,`local_row_update_time`,`update_time`) VALUES (?,?,?,?,?,?,?,?,?,?,NOW())");
    }
    ...
    public void initPs(PreparedStatement ps, Map<String, Object> datum) throws SQLException {
        ...
        ps.setString(6, PreparedStatementUtils.getStringVal("punishments", datum));
        PreparedStatementUtils.setLong(7, datum.get("created_time"),ps);
        PreparedStatementUtils.setDate(8, datum.get("punishment_date"), ps);
