 ...
 */
public class RadioModelApproveServiceImpl extends BaseService {

    @Override
    public void initInsertTmpSql(StringBuffer sqlBuf) {
        sqlBuf.append("INSERT INTO `t_radio_model_approve_tmp` (`id`,`_id`,`type`,`license_name`,`register_no`,`product_name`,`model`,`note`,`frequency_tolerance`,`frequency_range`,`transmit_power`,`occupied_bandwidth`,`spurious_emission_limit`,`valid_start`,`valid_end`,`state`,`state_code`,`approve_code`,`is_history`,`create_time`,`row_update_time`,`local_row_update_time`,`update_time`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,NOW())");
    }
    ...
    public void initPs(PreparedStatement ps, Map<String, Object> datum) throws Exception {
        ...
        ps.setString(7, PreparedStatementUtils.getStringVal("model", datum));
        ps.setString(8, PreparedStatementUtils.getStringVal("note", datum));
        ps.setString(9, PreparedStatementUtils.getStringVal("frequency_tolerance", datum));
        ps.setString(10, PreparedStatementUtils.getStringVal("frequency_range", datum));
        ps.setString(11, PreparedStatementUtils.getStringVal("transmit_power", datum));
        ps.setString(12, PreparedStatementUtils.getStringVal("occupied_bandwidth", datum));
        ps.setString(13, PreparedStatementUtils.getStringVal("spurious_emission_limit", datum));
        ...
        ps.setString(18, PreparedStatementUtils.getStringVal("approve_code", datum));
