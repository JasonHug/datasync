 ...
 */
public class UnicornEnterpriseServiceImpl extends BaseService {

    @Override
    public void initInsertTmpSql(StringBuffer sqlBuf) {
        sqlBuf.append("INSERT INTO `t_unicorn_enterprise_tmp` (`id`,`_id`,`eid`,`zz_eid`,`name`,`district`,`district_code`,`year`,`publish_date`,`remarks`,`state`,`state_code`,`level`,`url`,`unicorn_enterprise_type`,`is_history`,`u_tags`,`create_time`,`oss_url`,`row_update_time`,`local_row_update_time`,`update_time`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,NOW())");
    }
    ...
    public void initPs(PreparedStatement ps, Map<String, Object> datum) throws Exception {
        ...
        ps.setString(15, PreparedStatementUtils.getStringVal("unicorn_enterprise_type", datum));
