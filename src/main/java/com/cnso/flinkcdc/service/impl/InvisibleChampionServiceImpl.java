 ...
 */
public class InvisibleChampionServiceImpl extends BaseService {

    @Override
    public void initInsertTmpSql(StringBuffer sqlBuf) {
        sqlBuf.append("INSERT INTO `t_invisible_champion_tmp` (`id`,`_id`,`eid`,`zz_eid`,`name`,`district`,`district_code`,`year`,`publish_date`,`check_date`,`remarks`,`state`,`state_code`,`level`,`url`,`is_history`,`u_tags`,`create_time`,`oss_url`,`row_update_time`,`local_row_update_time`,`update_time`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,NOW())");
    }
    ...
    public void initPs(PreparedStatement ps, Map<String, Object> datum) throws Exception {
        ...
        ps.setString(10, PreparedStatementUtils.getStringVal("check_date", datum));
        ...
        ps.setString(14, PreparedStatementUtils.getStringVal("level", datum));
