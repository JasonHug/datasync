 ...
 */
public class HistoryOperNamesServiceImpl extends BaseService {

    @Override
    public void initInsertTmpSql(StringBuffer sqlBuf) {
        sqlBuf.append("INSERT INTO `t_history_oper_names_tmp` (`id`,`eid`,`zz_eid`,`date`,`name`,`pid`,`is_actual`,`u_tags`,`create_time`,`row_update_time`,`local_row_update_time`,`update_time`) VALUES (?,?,?,?,?,?,?,?,?,?,?,NOW())");
    }
    ...
    public void initPs(PreparedStatement ps, Map<String, Object> datum) throws SQLException {
        ...
        ps.setString(6, PreparedStatementUtils.getStringVal("pid", datum));
