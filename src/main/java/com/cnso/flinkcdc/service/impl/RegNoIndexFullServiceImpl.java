 ...
 */
public class RegNoIndexFullServiceImpl extends BaseService {

    @Override
    public void initInsertTmpSql(StringBuffer sqlBuf) {
        sqlBuf.append("INSERT INTO `t_reg_no_index_full_tmp` (`zz_id`,`id`,`reg_no`,`eid`,`zz_eid`,`province`,`credit_no`,`org_no`,`name`,`status`,`oper_name`,`start_date`,`history_names`,`his_eids`,`data`,`number`,`update_time`,`row_update_time`,`local_row_update_time`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
    }
    ...
    public void initPs(PreparedStatement ps, Map<String, Object> datum) throws Exception {
        ...
        ps.setString(3, PreparedStatementUtils.getStringVal("reg_no", datum));
