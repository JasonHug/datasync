 ...
 */
public class SpecializedAndNewEnterpriseServiceImpl extends BaseService {

    @Override
    public void initInsertTmpSql(StringBuffer sqlBuf) {
        sqlBuf.append("INSERT INTO `t_specialized_and_new_enterprise_tmp` (`id`,`_id`,`eid`,`zz_eid`,`name`,`district`,`district_code`,`year`,`publish_date`,`remarks`,`check_date`,`end_date`,`valid_start`,`valid_end`,`state`,`state_code`,`level`,`is_history`,`create_time`,`row_update_time`,`oss_url`,`local_row_update_time`,`update_time`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,NOW())");
    }
    ...
    public void initPs(PreparedStatement ps, Map<String, Object> datum) throws Exception {
        ...
        ps.setString(21, PreparedStatementUtils.getStringVal("oss_url", datum));
