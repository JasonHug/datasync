 ...
 */
public class MedicineExtractServiceImpl extends BaseService {

    @Override
    public void initInsertTmpSql(StringBuffer sqlBuf) {
        sqlBuf.append("INSERT INTO `t_medicine_extract_tmp` (`id`,`_id`,`type`,`license_name`,`register_no`,`approval_no`,`valid_start`,`valid_end`,`state`,`state_code`,`drug_name`,`production_enterprise`,`record_state`,`extract_info`,`related_companies`,`qds`,`url`,`u_tags`,`is_history`,`create_time`,`row_update_time`,`local_row_update_time`,`update_time`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,NOW())");
    }
    ...
    public void initPs(PreparedStatement ps, Map<String, Object> datum) throws Exception {
        ...
        ps.setString(6, PreparedStatementUtils.getStringVal("approval_no", datum));
        ...
        ps.setString(11, PreparedStatementUtils.getStringVal("drug_name", datum));
        ps.setString(12, PreparedStatementUtils.getStringVal("production_enterprise", datum));
        ps.setString(13, PreparedStatementUtils.getStringVal("record_state", datum));
        ps.setString(14, PreparedStatementUtils.getStringVal("extract_info", datum));
        ps.setString(15, PreparedStatementUtils.getStringVal("related_companies", datum));
        ps.setString(16, PreparedStatementUtils.getStringVal("qds", datum));
        ps.setString(17, PreparedStatementUtils.getStringVal("url", datum));
        PreparedStatementUtils.setInt(18, datum.get("u_tags"),ps);
