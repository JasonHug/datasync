 ...
 */
public class ManufacturingChampionServiceImpl extends BaseService {

    @Override
    public void initInsertTmpSql(StringBuffer sqlBuf) {
        sqlBuf.append("INSERT INTO `t_manufacturing_champion_tmp` (`id`,`_id`,`eid`,`zz_eid`,`name`,`district`,`district_code`,`year`,`publish_date`,`remarks`,`state`,`state_code`,`level`,`main_products`,`check_date`,`end_date`,`valid_start`,`valid_end`,`champion_enterprises_type`,`url`,`is_history`,`qds`,`u_tags`,`create_time`,`oss_url`,`row_update_time`,`local_row_update_time`,`update_time`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,NOW())");
    }
    ...
    public void initPs(PreparedStatement ps, Map<String, Object> datum) throws Exception {
        ...
        ps.setString(14, PreparedStatementUtils.getStringVal("main_products", datum));
        ps.setString(15, PreparedStatementUtils.getStringVal("check_date", datum));
        ps.setString(16, PreparedStatementUtils.getStringVal("end_date", datum));
        ps.setString(17, PreparedStatementUtils.getStringVal("valid_start", datum));
        ps.setString(18, PreparedStatementUtils.getStringVal("valid_end", datum));
        ps.setString(19, PreparedStatementUtils.getStringVal("champion_enterprises_type", datum));
        ps.setString(20, PreparedStatementUtils.getStringVal("url", datum));
        PreparedStatementUtils.setInt(21, datum.get("is_history"),ps);
        ps.setString(22, PreparedStatementUtils.getStringVal("qds", datum));
        PreparedStatementUtils.setInt(23, datum.get("u_tags"),ps);
        PreparedStatementUtils.setLong(24, datum.get("create_time"),ps);
        ps.setString(25, PreparedStatementUtils.getStringVal("oss_url", datum));
