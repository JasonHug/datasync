 ...
 */
public class TechnologyCenterServiceImpl extends BaseService {

    @Override
    public void initInsertTmpSql(StringBuffer sqlBuf) {
        sqlBuf.append("INSERT INTO `t_technology_center_tmp` (`id`,`_id`,`eid`,`zz_eid`,`name`,`district`,`district_code`,`technology_center`,`year`,`publish_date`,`level`,`check_date`,`end_date`,`state`,`state_code`,`u_tags`,`is_history`,`create_time`,`row_update_time`,`local_row_update_time`,`update_time`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,NOW())");
    }
    ...
    public void initPs(PreparedStatement ps, Map<String, Object> datum) throws Exception {
        ...
        ps.setString(8, PreparedStatementUtils.getStringVal("technology_center", datum));
