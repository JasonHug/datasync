 ...
 */
public class MakerSpaceServiceImpl extends BaseService {

    @Override
    public void initInsertTmpSql(StringBuffer sqlBuf) {
        sqlBuf.append("INSERT INTO `t_maker_space_tmp` (`id`,`_id`,`eid`,`zz_eid`,`name`,`district`,`district_code`,`maker_space`,`year`,`publish_date`,`remarks`,`level`,`check_date`,`end_date`,`state`,`state_code`,`source`,`url`,`u_tags`,`is_history`,`create_time`,`row_update_time`,`local_row_update_time`,`update_time`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,NOW())");
    }
    ...
    public void initPs(PreparedStatement ps, Map<String, Object> datum) throws Exception {
        ...
        ps.setString(8, PreparedStatementUtils.getStringVal("maker_space", datum));
        ps.setString(9, PreparedStatementUtils.getStringVal("year", datum));
        ps.setString(10, PreparedStatementUtils.getStringVal("publish_date", datum));
        ps.setString(11, PreparedStatementUtils.getStringVal("remarks", datum));
        ...
        ps.setString(17, PreparedStatementUtils.getStringVal("source", datum));
