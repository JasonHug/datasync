 ...
 */
public class SzsePidRelationServiceImpl extends BaseService {

    @Override
    public void initInsertTmpSql(StringBuffer sqlBuf) {
        sqlBuf.append("INSERT INTO `szse_pid_relation_tmp` (`zz_id`,`id`,`pid`,`eid`,`zz_eid`,`e_name`,`p_name`,`type`,`row_update_time`,`local_row_update_time`,`update_time`) VALUES (?,?,?,?,?,?,?,?,?,?,NOW())");
    }
    ...
    public void initPs(PreparedStatement ps, Map<String, Object> datum) throws Exception {
        ...
        ps.setString(6, PreparedStatementUtils.getStringVal("e_name", datum));
        ps.setString(7, PreparedStatementUtils.getStringVal("p_name", datum));
