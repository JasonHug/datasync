 ...
 */
public class EstateEualificationServiceImpl extends BaseService {

    @Override
    public void initInsertTmpSql(StringBuffer sqlBuf) {
        sqlBuf.append("INSERT INTO `t_estate_qualification_tmp` (`id`,`_id`,`type`,`license_name`,`register_no`,`level`,`valid_start`,`valid_end`,`state`,`state_code`,`province`,`province_code`,`address`,`oper_name`,`issue_unit`,`is_history`,`create_time`,`row_update_time`,`local_row_update_time`,`update_time`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,NOW())");
    }
    ...
    public void initPs(PreparedStatement ps, Map<String, Object> datum) throws Exception {
        ...
        ps.setString(11, PreparedStatementUtils.getStringVal("province", datum));
        ps.setString(12, PreparedStatementUtils.getStringVal("province_code", datum));
        ps.setString(13, PreparedStatementUtils.getStringVal("address", datum));
