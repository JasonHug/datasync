...
public class PrintServiceImpl extends BaseService {
    ...
    public void initInsertTmpSql(StringBuffer sqlBuf) {
        sqlBuf.append("INSERT INTO `t_print_tmp` (`id`,`_id`,`type`,`license_name`,`register_no`,`valid_start`,`valid_end`,`state`,`state_code`,`location`,`oper_name`,`report_state`,`is_history`,`create_time`,`row_update_time`,`local_row_update_time`,`update_time`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,NOW())");
    }
    ...
    public void initPs(PreparedStatement ps, Map<String, Object> datum) throws Exception {
        ...
        ps.setString(10, PreparedStatementUtils.getStringVal("location", datum));
        ps.setString(11, PreparedStatementUtils.getStringVal("oper_name", datum));
        ps.setString(12, PreparedStatementUtils.getStringVal("report_state", datum));
