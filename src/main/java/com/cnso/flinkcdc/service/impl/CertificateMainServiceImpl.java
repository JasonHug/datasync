 ...
 */
public class CertificateMainServiceImpl extends BaseService {

    @Override
    public void initInsertTmpSql(StringBuffer sqlBuf) {
        sqlBuf.append("INSERT INTO `t_certificate_main_tmp` (`zz_id`,`id`,`eid`,`zz_eid`,`_id`,`ename`,`register_no`,`type`,`license_name`,`valid_start`,`valid_end`,`state`,`state_code`,`province`,`province_code`,`is_history`,`create_time`,`row_update_time`,`local_row_update_time`,`update_time`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,NOW())");
    }
    ...
    public void initPs(PreparedStatement ps, Map<String, Object> datum) throws Exception {
        ...
        ps.setString(5, PreparedStatementUtils.getStringVal("_id", datum));
        ...
        ps.setString(9, PreparedStatementUtils.getStringVal("license_name", datum));
